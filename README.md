# Node.js Course - S18 Understanding Validation

Practice code for Section 18 - Understanding Validation, part of the course "NodeJS - The Complete Guide (MVC, REST APIs, GraphQL, Deno)" by Maximilian Schwarzmüller.

This project covers:
- Implementing input validation chains and sanitization with `express-validator`
- Displaying validation errors on forms
- Handling validation failures with custom middleware
- Re-populating user input after failed submissions
- Structuring validation logic for signup, login and product forms
- Maintaining secure and user-friendly data handling practices
...
## 1) Clone the repo
```bash
git clone https://github.com/S18-Understanding-Validation
cd ./S18-Understanding-Validation
```
